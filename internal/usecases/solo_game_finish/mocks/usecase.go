...
func (m *Mockstorage) Finalize(ctx context.Context, userID, gameID string, userNumbers []int32, bingo int32) (int64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Finalize", ctx, userID, gameID, userNumbers, bingo)
	ret0, _ := ret[0].(int64)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockstorageMockRecorder) Finalize(ctx, userID, gameID, userNumbers, bingo any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Finalize", reflect.TypeOf((*Mockstorage)(nil).Finalize), ctx, userID, gameID, userNumbers, bingo)
}
