...
// Unrate mocks base method.
func (m *Mockstorage) Unrate(ctx context.Context, userID, packID string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Unrate", ctx, userID, packID)
	ret0, _ := ret[0].(error)
	return ret0
}

// Unrate indicates an expected call of Unrate.
func (mr *MockstorageMockRecorder) Unrate(ctx, userID, packID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Unrate", reflect.TypeOf((*Mockstorage)(nil).Unrate), ctx, userID, packID)
}
