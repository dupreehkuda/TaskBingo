...
func (m *Mockstorage) Rate(ctx context.Context, userID, packID string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Rate", ctx, userID, packID)
	ret0, _ := ret[0].(error)
	return ret0
}

// Rate indicates an expected call of Rate.
func (mr *MockstorageMockRecorder) Rate(ctx, userID, packID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Rate", reflect.TypeOf((*Mockstorage)(nil).Rate), ctx, userID, packID)
}
