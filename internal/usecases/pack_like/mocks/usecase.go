...
func (m *Mockstorage) Like(ctx context.Context, userID, packID string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Like", ctx, userID, packID)
	ret0, _ := ret[0].(error)
	return ret0
}

// Like indicates an expected call of Like.
func (mr *MockstorageMockRecorder) Like(ctx, userID, packID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Like", reflect.TypeOf((*Mockstorage)(nil).Like), ctx, userID, packID)
}
