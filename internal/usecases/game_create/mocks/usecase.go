...
func (m *Mockstorage) Create(ctx context.Context, game *models.Game) error {
	m.ctrl.T.Helper()
...
func (mr *MockstorageMockRecorder) Create(ctx, game any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Create", reflect.TypeOf((*Mockstorage)(nil).Create), ctx, game)
}
