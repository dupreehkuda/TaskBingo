...
DO $$ BEGIN
    ALTER TABLE login ADD CONSTRAINT login_id_fkey FOREIGN KEY (id) REFERENCES users(id);
EXCEPTION
    WHEN duplicate_object THEN NULL;
END $$;

DO $$ BEGIN
    ALTER TABLE friends ADD CONSTRAINT friends_id_fkey FOREIGN KEY (id) REFERENCES users(id);
EXCEPTION
    WHEN duplicate_object THEN NULL;
END $$;

DO $$ BEGIN
    ALTER TABLE packs ADD CONSTRAINT packs_creator_fkey FOREIGN KEY (creator) REFERENCES users(id);
EXCEPTION
    WHEN duplicate_object THEN NULL;
END $$;
